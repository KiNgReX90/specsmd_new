...
**Command**: `/specsmd-aidlc-turbo-operations`
...
→ `.specsmd/aidlc-turbo/agents/operations-agent.md`
...
- **Build**: `.specsmd/aidlc-turbo/skills/operations/build.md` → Create deployment artifacts
- **Deploy**: `.specsmd/aidlc-turbo/skills/operations/deploy.md` → Deploy to environment
- **Verify**: `.specsmd/aidlc-turbo/skills/operations/verify.md` → Validate deployment
- **Monitor**: `.specsmd/aidlc-turbo/skills/operations/monitor.md` → Setup observability
- **Menu**: `.specsmd/aidlc-turbo/skills/operations/navigator.md` → Show skills
