...
<CardGroup cols={2}>
  <Card title="Add New Standards" icon="plus">
    Add entries to `standards:` with facilitation guides
  </Card>
  <Card title="Custom Decisions" icon="sliders">
    Add decisions to existing standards
  </Card>
  <Card title="Project Types" icon="folder-tree">
    Define custom project type presets
  </Card>
  <Card title="Dependencies" icon="link">
    Control order via `depends_on_standards`
  </Card>
</CardGroup>
