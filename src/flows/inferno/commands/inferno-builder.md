...
- **Report the check.** Add one line to `notes`, for example `design-fidelity: verified against <source>`, or name the values you could not confirm. Pixel-level appearance is still confirmed downstream by screenshots and human eyes; your job here is exact conformance to the cited values.
