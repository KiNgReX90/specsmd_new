...
- **Oracle**: `specsmd-inferno-oracle`, spawned by the orchestrator (`claude-opus-5-5`, effort max) for any judgment call a builder or the orchestrator would otherwise postpone or hand to the user
