...
description: Decision specialist for INFERNO. Answers a judgment call a builder, orchestrator, planner or session would otherwise postpone, from the artifact, on the frontier tier.
version: 1.0.0
