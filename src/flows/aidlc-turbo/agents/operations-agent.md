...
When user invokes `/specsmd-aidlc-turbo-operations --unit="{name}"`:
...
|---------|-------|-------------|
| `menu` | `.specsmd/aidlc-turbo/skills/operations/menu.md` | Show deployment status and options |
| `build` | `.specsmd/aidlc-turbo/skills/operations/build.md` | Build deployment artifacts |
| `deploy` | `.specsmd/aidlc-turbo/skills/operations/deploy.md` | Deploy to environment |
| `verify` | `.specsmd/aidlc-turbo/skills/operations/verify.md` | Verify deployment success |
| `monitor` | `.specsmd/aidlc-turbo/skills/operations/monitor.md` | Setup monitoring and observability |
| `rollback` | `.specsmd/aidlc-turbo/skills/operations/rollback.md` | Rollback to previous version |
