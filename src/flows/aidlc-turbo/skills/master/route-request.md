...
- **No intents / New feature request** → Inception Agent → `/specsmd-aidlc-turbo-inception`
- **Intent exists, needs elaboration** → Inception Agent → `/specsmd-aidlc-turbo-inception --intent="{name}"`
- **Ready for construction** → Construction Agent → `/specsmd-aidlc-turbo-construction --unit="{name}"`
- **Bolt in progress** → Construction Agent → `/specsmd-aidlc-turbo-construction --unit="{name}" --bolt-id="{id}"`
- **Ready for deployment** → Operations Agent → `/specsmd-aidlc-turbo-operations --unit="{name}"`
- **In production, needs monitoring** → Operations Agent → `/specsmd-aidlc-turbo-operations --unit="{name}"`
