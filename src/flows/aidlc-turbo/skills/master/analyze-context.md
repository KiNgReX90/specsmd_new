...
Read `.specsmd/aidlc-turbo/memory-bank.yaml` to understand artifact paths:
...
- Find all bolts for unit: `.specs-aidlc-turbo/bolts/bolt-{unit}-*/bolt.md`
...
- Log changes to `.specs-aidlc-turbo/maintenance-log.md`
- Report changes made

#### 6.6 Log to Maintenance Log

Append entry to `.specs-aidlc-turbo/maintenance-log.md` (create if doesn't exist):
