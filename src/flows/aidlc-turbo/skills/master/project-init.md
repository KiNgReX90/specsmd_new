...
- **Required**: `.specsmd/aidlc-turbo/templates/standards/catalog.yaml` - defines available standards
...
Read `.specsmd/aidlc-turbo/templates/standards/catalog.yaml` to understand:
...
**IMPORTANT**: After determining project type, immediately save it to `.specs-aidlc-turbo/project.yaml`:
...
### Suggested Next Step
→ **inception** - Create your first intent with `/specsmd-aidlc-turbo-inception`
...
> "I can't find the standards catalog. Please ensure `.specsmd/aidlc-turbo/templates/standards/catalog.yaml` exists."
