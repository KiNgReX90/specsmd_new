...
Standards are saved to `.specs-aidlc-turbo/standards/` and provide context for all AI agents.
...
```text
/specsmd-aidlc-turbo-inception intent-create
```
...
```text
/specsmd-aidlc-turbo-inception bolt-plan
```
...
```text
/specsmd-aidlc-turbo-construction bolt-start
```
...
```text
/specsmd-aidlc-turbo-operations deploy
```
...
### Master Agent (`/specsmd-aidlc-turbo`)
...
### Inception Agent (`/specsmd-aidlc-turbo-inception`)
...
### Construction Agent (`/specsmd-aidlc-turbo-construction`)
...
### Operations Agent (`/specsmd-aidlc-turbo-operations`)
...
.specs-aidlc-turbo/                      # Created after project-init
...
- Clear `.specs-aidlc-turbo/` to reset artifacts
...
1. Run `/specsmd-aidlc-turbo` and type `project-init` to set up your project
2. Create your first intent with `/specsmd-aidlc-turbo-inception intent-create`
