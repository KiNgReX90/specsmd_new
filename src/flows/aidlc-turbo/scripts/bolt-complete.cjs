 ...
 *   │                                                                  │
 *   │ - Scans .specs-aidlc-turbo/bolts/ for matching directory                 │
 ...
 *   │                                                                  │
 *   │ 1. Scan .specs-aidlc-turbo/bolts/ for bolts with matching unit         │
 ...
 *
 *     node .specsmd/aidlc-turbo/scripts/bolt-complete.cjs 016-analytics-tracker
 *
 *   With optional stage name:
 *
 *     node .specsmd/aidlc-turbo/scripts/bolt-complete.cjs 016-analytics-tracker --last-stage test
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 */
