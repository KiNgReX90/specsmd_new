...
**Location**: `.specs-aidlc-turbo/bolts/{bolt-id}/implementation-plan.md`
...
- `implementation-walkthrough.md` - `.specs-aidlc-turbo/bolts/{bolt-id}/implementation-walkthrough.md`
...
**Location**: `.specs-aidlc-turbo/bolts/{bolt-id}/test-walkthrough.md`
