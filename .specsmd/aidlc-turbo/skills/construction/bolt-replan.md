# Skill: Regroup Stories (lean) / Replan Bolts (full)

---

## Role

Utility skill to adjust the build plan during Construction.

- **lean (default):** regroup or reorder the **stories** within/across units as you learn
  during execution — record the regrouping in the unit's construction-log. There are no
  bolt files to edit.
- **full (legacy):** add, split, or reorder **bolts**.

**NO Checkpoint** - Replanning is a utility operation. Changes are validated through normal stage execution checkpoints.
...
2. **Determine next bolt ID**:
   - List all directories in `.specs-aidlc-turbo/bolts/`
...
3. **Create new bolt(s)**:
   - Use template: `.specsmd/aidlc-turbo/templates/construction/bolt-template.md`
   - All bolts use type `ddd-construction-bolt` (see: `.specsmd/aidlc-turbo/templates/construction/bolt-types/ddd-construction-bolt.md`)
...
4. **Output**:
   ...
   File created: `.specs-aidlc-turbo/bolts/004-auth-service/bolt.md`
   ```
...
4. **Output**:
   ...
   Updated files:
   - `.specs-aidlc-turbo/bolts/003-auth-service/bolt.md` (updated)
   - `.specs-aidlc-turbo/bolts/004-auth-service/bolt.md` (created)
   - `.specs-aidlc-turbo/bolts/002-auth-service/bolt.md` (updated enables_bolts)
   ```
...
5. **Output**:
   ...
   Updated files:
   - `.specs-aidlc-turbo/bolts/003-auth-service/bolt.md` (requires_bolts updated)
   - `.specs-aidlc-turbo/bolts/004-auth-service/bolt.md` (requires_bolts updated)
   ```
...
See full template: `.specsmd/aidlc-turbo/templates/construction/bolt-template.md`
