...
Save to `.specs-aidlc-turbo/prototypes/{prototype-name}/`:
...
### Artifacts Created
- `.specs-aidlc-turbo/prototypes/{name}/screen-inventory.md`
- `.specs-aidlc-turbo/prototypes/{name}/design-system.md`
- `.specs-aidlc-turbo/prototypes/{name}/component-catalog.md`
- `.specs-aidlc-turbo/prototypes/{name}/user-flows.md`
- `.specs-aidlc-turbo/prototypes/{name}/derived-requirements.md`
