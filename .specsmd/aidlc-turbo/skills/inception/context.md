...
1. **Read Path**: Check `schema.system_context` from `.specsmd/aidlc-turbo/memory-bank.yaml`
   *(Default: `.specs-aidlc-turbo/intents/{intent-name}/system-context.md`)*

2. **Use Template**: `.specsmd/aidlc-turbo/templates/inception/system-context-template.md`
