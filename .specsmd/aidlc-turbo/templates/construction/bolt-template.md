...
```text
.specs-aidlc-turbo/bolts/{bolt-id}/
...
**Type**: {type name}
**Definition**: `.specsmd/aidlc-turbo/templates/construction/bolt-types/{type}.md`
...
**Type**: DDD Construction Bolt
**Definition**: `.specsmd/aidlc-turbo/templates/construction/bolt-types/ddd-construction-bolt.md`
