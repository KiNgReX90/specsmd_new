...
When user invokes `/specsmd-aidlc-turbo`:
...
|---------|-------|-------------|
| `init`, `project-init` | `.specsmd/aidlc-turbo/skills/master/project-init.md` | Initialize project with standards |
| `analyze` | `.specsmd/aidlc-turbo/skills/master/analyze-context.md` | Analyze project state |
| `route` | `.specsmd/aidlc-turbo/skills/master/route-request.md` | Route to specialist agent |
| `explain` | `.specsmd/aidlc-turbo/skills/master/explain-flow.md` | Explain AI-DLC methodology |
| `answer` | `.specsmd/aidlc-turbo/skills/master/answer-question.md` | Answer questions |
