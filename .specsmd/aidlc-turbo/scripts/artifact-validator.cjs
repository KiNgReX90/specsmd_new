 ...
 *
 * Usage:
 *   node .specsmd/aidlc-turbo/scripts/artifact-validator.cjs
 *   node .specsmd/aidlc-turbo/scripts/artifact-validator.cjs --json
 *   node .specsmd/aidlc-turbo/scripts/artifact-validator.cjs --fix
 *
...
class ArtifactValidator {
    constructor(memoryBankPath = '.specs-aidlc-turbo') {
        ...
        if (this.results.length === 0) {
            ...
            for (const [type, issues] of Object.entries(byType)) {
                ...
                for (const issue of issues) {
                    ...
                    const shortPath = issue.file.replace(/^\.specs-aidlc-turbo\//, '');
